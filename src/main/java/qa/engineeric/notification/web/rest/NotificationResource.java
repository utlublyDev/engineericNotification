package qa.engineeric.notification.web.rest;
...
import qa.engineeric.notification.repository.NotificationRepository;
import qa.engineeric.notification.web.rest.errors.BadRequestAlertException;
import tech.jhipster.web.util.HeaderUtil;
import tech.jhipster.web.util.ResponseUtil;

/**
 * REST controller for managing {@link qa.engineeric.notification.domain.Notification}.
 */
@RestController
@RequestMapping("/api")
    ...
    public ResponseEntity<Notification> partialUpdateNotification(
        ...
        Optional<Notification> result = notificationRepository
            ...
            .map(existingNotification -> {
                if (notification.getUserStoreOwnerId() != null) {
                    existingNotification.setUserStoreOwnerId(notification.getUserStoreOwnerId());
                }
