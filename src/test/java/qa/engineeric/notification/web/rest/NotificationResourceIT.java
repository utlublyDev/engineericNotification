...
import qa.engineeric.notification.IntegrationTest;
...
class NotificationResourceIT {
    ...
    void createNotification() throws Exception {
        ...
        assertThat(testNotification.getUserStoreOwnerId()).isEqualTo(DEFAULT_USER_STORE_OWNER_ID);
    ...
    void checkUserStoreOwnerIdIsRequired() throws Exception {
        ...
        // set the field null
        notification.setUserStoreOwnerId(null);
    ...
    void putNewNotification() throws Exception {
        ...
        Notification testNotification = notificationList.get(notificationList.size() - 1);
        assertThat(testNotification.getUserStoreOwnerId()).isEqualTo(UPDATED_USER_STORE_OWNER_ID);
